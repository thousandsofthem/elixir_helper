defmodule Helper.StatsProcess do
  @moduledoc ~S"""
  Process and pid handling.
  """

  import Helper.StatsHelper, only: [string_to_module: 1, format_function: 1]
  ...
  def meta(pid), do: pid |> process_info(@process_meta, &structure_meta/2)
  ...
  def summary(pid), do: pid |> process_info(@process_summary, &structure_summary/2)
