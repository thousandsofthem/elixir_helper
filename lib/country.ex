defmodule Helper.Countries do
  ...
  @countries [
    ...
    %Country{iso: "AN", name: "Netherlands Antilles", prefix: "+599"},
    %Country{iso: "AO", name: "Angola", prefix: "+244"},
    %Country{iso: "AR", name: "Argentina", prefix: "+54"},
    %Country{iso: "AS", name: "American Samoa", prefix: "+1684"},
    ...
    %Country{iso: "CK", name: "Cook Islands", prefix: "+682"},
    ...
    %Country{iso: "CW", name: "Curaçao", prefix: "+599"},
    ...
    %Country{iso: "DO", name: "Dominican Republic", prefix: ["+1809", "+1829", "+1849"]},
    ...
    %Country{iso: "FO", name: "Faroe Islands", prefix: "+298"},
    ...
    %Country{iso: "GU", name: "Guam", prefix: "+1671"},
    ...
    %Country{iso: "IM", name: "Isle of Man", prefix: "+441624"},
    %Country{iso: "IN", name: "India", prefix: "+91"},
    %Country{iso: "IO", name: "British Indian Ocean Territory", prefix: "+246"},
    ...
    %Country{iso: "KI", name: "Kiribati", prefix: "+686"},
    ...
    %Country{iso: "MF", name: "Saint Martin", prefix: "+590"},
    %Country{iso: "MG", name: "Madagascar", prefix: "+261"},
    %Country{iso: "MH", name: "Marshall Islands", prefix: "+692"},
    ...
    %Country{iso: "MQ", name: "Martinique", prefix: "+596"},
    ...
    %Country{iso: "NC", name: "New Caledonia", prefix: "+687"},
    %Country{iso: "NE", name: "Niger", prefix: "+227"},
    %Country{iso: "NF", name: "Norfolk Island", prefix: "+672"},
    ...
    %Country{iso: "NR", name: "Nauru", prefix: "+674"},
    %Country{iso: "NU", name: "Niue", prefix: "+683"},
    ...
    %Country{iso: "PM", name: "St Pierre and Miquelon", prefix: "+508"},
    %Country{iso: "PR", name: "Puerto Rico", prefix: ["+1787", "+1939"]},
    %Country{iso: "PS", name: "Palestine", prefix: "+970"},
    ...
    %Country{iso: "RE", name: "Reunion/Mayotte", prefix: "+262"},
    ...
    %Country{iso: "SS", name: "South Sudan", prefix: "+211"},
    ...
    %Country{iso: "TK", name: "Tokelau", prefix: "+690"},
    ...
    %Country{iso: "TV", name: "Tuvalu", prefix: "+688"},
    ...
    %Country{iso: "WF", name: "Wallis and Futuna", prefix: "+681"},
    %Country{iso: "WS", name: "Samoa", prefix: "+685"},
    %Country{iso: "XK", name: "Kosovo", prefix: "+383"},
